...
async function button_clicked(title) {
  ...
  correct_input.setAttribute('class','form-control')
  correct_input.value = question["correct"]
  correct_input.style = "width:680px;"

  var correct_lbl = document.createElement('label')
  correct_lbl.setAttribute('for', 'Option' + 1+":")
  correct_lbl.textContent = "Correct answer:"

  var form_div = document.createElement('div');
  form_div.setAttribute('class', 'form-floating')
  form_div.appendChild(correct_input)
  form_div.appendChild(correct_lbl)
  question_div.appendChild(form_div)
